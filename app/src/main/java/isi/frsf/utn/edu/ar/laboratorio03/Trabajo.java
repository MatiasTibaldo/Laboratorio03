...
public class Trabajo implements Parcelable {
    ...
    public static TrabajoDao trabajoDao;
    ...
    public Trabajo(Integer id, String descripcion, Integer horasPresupuestadas, int idCategoria, Double precioMaximoHora, Date fechaEntrega, Integer monedaPago, Boolean requiereIngles) {
        this.id = id;
        this.descripcion = descripcion;
        this.horasPresupuestadas = horasPresupuestadas;
        try{
            for(Categoria cat : trabajoDao.listaCategoria()){
    ...
    public static final Creator<Trabajo> CREATOR = new Creator<Trabajo>() {
        @Override
        public Trabajo createFromParcel(Parcel in) { return new Trabajo(in); }
    ...
    public static void setDao(TrabajoDao tr){
        trabajoDao = tr;
    }
    ...
    public Integer getBandera(){
        ...
        switch(monedaPago) {
            ...
            case 3: {
                bandera = R.drawable.ar;
                break;
            }
            case 4: {
                bandera = R.drawable.uk;
                break;
            }
            case 5: {
                bandera = R.drawable.br;
                break;
            }
        }
        return bandera;
    ...
    public void asignarCategoria(){
        Random r =new Random();
        try{
            if(trabajoDao != null && trabajoDao.listaCategoria() != null && trabajoDao.listaCategoria().size() > 0){
                this.categoria = trabajoDao.listaCategoria().get(r.nextInt(trabajoDao.listaCategoria().size()));
            }
            else{
                this.categoria = null;
            }
